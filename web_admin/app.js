...
function defaultScheduleRuleTemplates() {
  ...
  const rule = (id, name, keywords, startDate, endDate, periods, weekdaysValue, hours, notes, extra = {}) => ({
    rule_id: id,
    rule_name: name,
    scope_type: "keywords",
    product_id: "",
  ...
  return [
    rule(
      ...
      tueSat,
      0,
      "开课后周二到周六正常排课；周一仅特殊情况使用，自动排课默认不排周一。",
      { exception_weekdays: ["周一"], delivery_mode: "混合" },
    ),
    rule("RULE_HSY_WYH_WINTER_DAY", "寒暑营/无忧寒：1-2月白天", ["寒暑营", "无忧寒"], "2026-01-01", "2026-02-28", day, monSat, 4, "1月、2月每周一到周六白天排课。"),
    rule("RULE_HSY_WYH_SPRING_EVENING", "寒暑营/无忧寒：4-6月晚上", ["寒暑营", "无忧寒"], "2026-04-01", "2026-06-30", evening, tueFri, 2, "4月、5月、6月每周二到周五晚上排课。"),
    rule("RULE_HSY_WYH_SUMMER_DAY", "寒暑营/无忧寒：7-8月白天", ["寒暑营", "无忧寒"], "2026-07-01", "2026-08-31", day, monSat, 4, "7月、8月每周一到周六白天排课。"),
    rule("RULE_HSY_WYH_AUTUMN_EVENING", "寒暑营/无忧寒：9-12月晚上", ["寒暑营", "无忧寒"], "2026-09-01", "2026-12-31", evening, tueFri, 2, "9月到12月每周二到周五晚上排课。"),
    rule("RULE_WYQC_SPRING_WEEKEND_DAY", "无忧秋/无忧春：3-6月周末白天", ["无忧秋", "无忧春"], "2026-03-01", "2026-06-30", day, satSun, 4, "3月、4月、5月、6月每周六周日白天排课。"),
    rule("RULE_WYQC_SUMMER_DAY", "无忧秋/无忧春：7-8月白天", ["无忧秋", "无忧春"], "2026-07-01", "2026-08-31", day, monSat, 4, "7月、8月每周一到周六白天排课。"),
    rule("RULE_WYQC_AUTUMN_WEEKEND_DAY", "无忧秋/无忧春：9-12月周末白天", ["无忧秋", "无忧春"], "2026-09-01", "2026-12-31", day, satSun, 4, "9月到12月每周六周日白天排课。"),
    rule("RULE_WYS_SUMMER_DAY", "无忧暑：7-8月白天", ["无忧暑"], "2026-07-01", "2026-08-31", day, monSat, 4, "7月、8月每周一到周六白天排课。"),
    rule("RULE_WYS_AUTUMN_WED_WEEKEND_DAY", "无忧暑：9-12月周三/周末白天", ["无忧暑"], "2026-09-01", "2026-12-31", day, wedSatSun, 4, "9月到12月每周三、周六、周日白天排课。"),
    rule("RULE_SJY_SUMMER_DAY", "暑假营：7-8月白天", ["暑假营"], "2026-07-01", "2026-08-31", day, monSat, 4, "7月、8月每周一到周六白天排课。"),
    rule("RULE_SJY_AUTUMN_EVENING", "暑假营：9-12月晚上", ["暑假营"], "2026-09-01", "2026-12-31", evening, tueFri, 2, "9月到12月每周二到周五晚上排课。"),
  ];
}
