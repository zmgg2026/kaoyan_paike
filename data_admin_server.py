...
def normalize_class(cls: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "actual_schedule_window_ids": split_id_list(cls.get("actual_schedule_window_ids")),
...
def product_stage_order(product: Dict[str, Any], cls: Optional[Dict[str, Any]] = None) -> List[str]:
    cls = cls or {}
    stages = split_id_list(cls.get("selected_stages")) or split_id_list(cls.get("stages")) or split_id_list(product.get("applicable_stages"))
...
def product_catalog(products: List[Dict[str, Any]], product_courses: List[Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
    ...
    for course in product_courses:
        ...
        catalog[product_id] = {
            ...
            "sub_product": infer_sub_product(infer_product_line(product_name, project=project), product_name),
            "product_system": "",
            "standard_capacity": 0,
            "capacity_type": "",
            "subject": "",
